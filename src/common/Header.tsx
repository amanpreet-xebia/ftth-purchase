  ...
  return (
    <>
      ...
      >
        ...
        >
          <Link
            href={`${process.env.SALAM_URL}${header?.personal}/personal`}
            target="_blank"
          >
            {header?.personal}
          </Link>
        ...
        >
          <Link
            href={`${process.env.SALAM_URL}${header?.business}/business`}
            target="_blank"
          >
            {header?.business}
          </Link>
        ...
        >
          <Link
            href={`${process.env.SALAM_URL}${header?.about}/slm/about`}
            target="_blank"
          >
            {header?.about}
          </Link>
        ...
        >
          <Link
            href={`${process.env.SALAM_URL}${header?.complaint}/support/complaints`}
          >
            {header?.complaint}
          </Link>
        </button>
