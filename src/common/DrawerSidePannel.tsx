...
const DrawerSidePannel = (props: any) => {
  ...
  const { drawerSideOption }: any = value?.state?.languages;
    ...
    <div className=" bg-salam-blue">
      ...
      <div className=" h-screen bg-salam-blue text-white overflow-y-scroll  hide-scrollbar z-100 text-xl">
        <div className="px-8 py-16 flex-1">
          <div className=" pt-12 ">
            <div className=" text-accent text-4xl flex">
              {drawerSideOption?.fiber}
            </div>
            <div className=" pl-8 pt-8  pb-16 font-bold flex flex-col gap-6">
              <div>
                <a
                  href={`${process.env.SALAM_URL}${lang}/personal/fiber-prepaid`}
                  className="z-200"
                >
              ...
              <div>
                <a
                  href={`${process.env.SALAM_URL}${lang}/personal/fiber-postpaid`}
                  className="z-200"
                >
              ...
              <div>
                <a
                  href={`${process.env.SALAM_URL}${lang}/personal/gaming`}
                  className="z-200"
                >
              ...
              <div>
                <a
                  href={`${process.env.SALAM_URL}${lang}/personal/orbit-family-pack`}
                >
            ...
            <div className="  pl-8 pt-8  pb-16 font-bold flex flex-col gap-6">
              <div>
                <a
                  href={`${process.env.SALAM_URL}${lang}/personal/orbit-family-pack`}
                >
                  {drawerSideOption?.salam_5g}
                </a>
              </div>
              <div>
                <a
                  href={`${process.env.SALAM_URL}${lang}/personal/5g-coverage-check`}
                >
          ...
          <div className=" flex-none text-xl flex flex-col gap-6 font-thin py-8">
            ...
            <div>
              <a href={`${process.env.SALAM_URL}${lang}/slm/about`}>
                {drawerSideOption?.about_salam}
              </a>
            </div>
            <div>
              <a href={`${process.env.SALAM_URL}${lang}/support/complaints`}>
                {drawerSideOption?.complaints}
              </a>
            </div>
            <div>
              <a href={`${process.env.SALAM_URL}${lang}/personal`}>
                {drawerSideOption?.contact_us}
              </a>
            </div>
          </div>
        </div>
